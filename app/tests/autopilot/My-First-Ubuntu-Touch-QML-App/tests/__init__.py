...
import My-First-Ubuntu-Touch-QML-App
...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('My-First-Ubuntu-Touch-QML-App', 'Jaft')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = My-First-Ubuntu-Touch-QML-App.TouchApp(self.launcher(), self.test_type)
